...
<div class="ocean">
      ...
      <div class="hero-left">
        ...
        <div class="socials">
          ...
          <a
            ...
            aria-label="Discord"
          >
            <SiDiscord size={20} title="" />
          </a>
          <a
            href="https://www.instagram.com/mark.kdrv/"
            target="_blank"
            rel="noopener"
            aria-label="Instagram"
          >
            <SiInstagram size={20} title="" />
          </a>
          <a
            href="https://t.me/xhoss"
            target="_blank"
            rel="noopener"
            aria-label="Telegram"
          >
            <SiTelegram size={20} title="" />
          </a>
  ...
  <section class="about reveal">
    <p>
      hi, i'm mark, a software developer based in toronto. russian by origin,
      canadian by circumstance, occasionally touching grass elsewhere. i have a
      habit of solving problems i created myself, in systems i didn't need to
      build, for reasons i can't fully explain. somewhere along the way it
      became a personality, and this website is where that lives. think of it as
      my corner of the internet that isn't a resume.
    </p>
  </section>
        ...
        {#each projects as project}
          ...
          <li>
            <div
              ...
              onkeydown={(e) =>
                e.key === "Enter" && toggleProject(project.name)}
            >
              <div class="card-row">
